window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$1 = "[data-gb-sidebar-col]{border:1px solid var(--dsw-alias-border-l2);box-shadow:var(--dsw-shadow-lv2);background:var(--dsw-alias-bg-base);border-radius:22px;margin:8px;overflow:hidden}[data-gb-sidebar-root]{background:var(--dsw-alias-bg-base)}div:has(>[data-shell-overlay]):not([data-sidebar-collapsed]) [data-gb-sidebar-root]{padding-top:0;width:auto!important}div:has(>[data-shell-overlay]):not([data-sidebar-collapsed]) [data-gb-sidebar-root]>:first-child{height:48px;margin-bottom:4px}div:has(>[data-shell-overlay])[data-sidebar-collapsed] [data-gb-sidebar-col]{border-left:none;border-right:1px solid var(--dsw-alias-border-l2);border-radius:0 22px 22px 0;margin:0}[data-gb-sidebar-scrollport],[data-gb-root]{position:relative}[data-gb-root] [data-conversation-scroll]{padding-top:var(--dsh-gb-header-bottom,0px)}[data-gb-header]{z-index:6;width:fit-content;max-width:calc(100% - 144px);box-shadow:var(--dsw-shadow-lv2);background:0 0;border-radius:22px;margin:0;position:absolute;top:8px;left:8px}[data-gb-header]:before{content:\"\";z-index:-1;border-radius:inherit;border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-base) 78%, transparent);backdrop-filter:blur(var(--dsh-gb-card-blur,18px)) saturate(160%);position:absolute;inset:0}[data-gb-header]:after{display:none}.md-code-block>[class*=bannerWrap]{z-index:5;top:0}[data-gb-header]>div:first-child>div:last-child{z-index:3;margin:0;position:fixed;top:8px;right:8px}[data-gb-header]>div:first-child>div:last-child button:first-child{background:var(--dsw-alias-bg-base);box-shadow:var(--dsw-shadow-lv2);border-radius:16px}[data-gb-fade-top],[data-gb-fade-bottom],[data-gb-fade-sidebar-top],[data-gb-fade-sidebar-bottom]{z-index:5;pointer-events:none;opacity:0;transition:opacity .18s var(--ds-ease-in-out);position:fixed;overflow:hidden}[data-gb-fade-top],[data-gb-fade-sidebar-top]{background:linear-gradient(to bottom, var(--dsw-alias-bg-base), transparent)}[data-gb-fade-bottom],[data-gb-fade-sidebar-bottom]{background:linear-gradient(to top, var(--dsw-alias-bg-base), transparent)}[data-composer-seat]{pointer-events:none;z-index:7}[data-gb-root][data-phase=active] [data-composer-seat]{background:linear-gradient(to top, var(--dsw-alias-bg-base) 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 82%, transparent) 45%, color-mix(in srgb, var(--dsw-alias-bg-base) 12%, transparent) 100%)}[data-composer-seat]>*{pointer-events:auto}[data-composer-card]{backdrop-filter:blur(var(--dsh-gb-card-blur,18px)) saturate(160%);background:color-mix(in srgb, var(--dsw-alias-bg-base) 84%, transparent);box-shadow:var(--dsw-shadow-lv2)}[data-gb-sidebar-root]>button{background:var(--dsw-alias-bg-base)}[data-gb-chat-viewport]{padding-bottom:24px}@media (prefers-reduced-motion:reduce){[data-gb-fade-top],[data-gb-fade-bottom],[data-gb-fade-sidebar-top],[data-gb-fade-sidebar-bottom]{transition:none}}";
